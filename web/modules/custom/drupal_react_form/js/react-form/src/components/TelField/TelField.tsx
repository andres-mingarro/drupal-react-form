...
import './TelField.scss';

export function TelField({ name, element, formValues, onChange, onBlur, error }: BaseFieldProps) {
  ...
  return (
    <div className={`drf-field drf-field--tel${hasError ? ' drf-field--error' : ''}`}>
