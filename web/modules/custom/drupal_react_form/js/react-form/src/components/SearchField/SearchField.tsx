...
export function SearchField({ name, element, formValues, onChange, onBlur, error }: BaseFieldProps) {
  ...
  return (
    <div className={`drf-field drf-field--search${hasError ? ' drf-field--error' : ''}`}>
