...
export function TextField({ name, element, formValues, onChange, onBlur, error }: BaseFieldProps) {
  ...
  return (
    <div className={`drf-field drf-field--textfield${hasError ? ' drf-field--error' : ''}`}>
