...
export function PasswordField({ name, element, formValues, onChange, onBlur, error }: BaseFieldProps) {
  ...
  return (
    <div className={`drf-field drf-field--password${hasError ? ' drf-field--error' : ''}`}>
