...
export function EmailField({ name, element, formValues, onChange, onBlur, error }: BaseFieldProps) {
  ...
  return (
    <div className={`drf-field drf-field--email${hasError ? ' drf-field--error' : ''}`}>
