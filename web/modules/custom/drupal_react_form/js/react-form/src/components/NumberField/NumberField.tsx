...
export function NumberField({ name, element, formValues, onChange, onBlur, error }: BaseFieldProps) {
  ...
  return (
    <div className={`drf-field drf-field--number${hasError ? ' drf-field--error' : ''}`}>
